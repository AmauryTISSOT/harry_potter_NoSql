...
from .controllers.moviescontroller import (get_apparition_total,get_apparaition_movie_one, get_apparaition_movie_two, get_apparaition_movie_three,get_apparaition_movie_four, get_apparaition_movie_five, get_apparaition_movie_six, get_apparaition_movie_seven, get_apparaition_movie_eight)
